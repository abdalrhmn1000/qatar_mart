...
class _HomeState extends State<Home> with TickerProviderStateMixin {
                      ...
                      RefreshIndicator(
                        ...
                        child: CustomScrollView(
                          ...
                          slivers: <Widget>[
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Align(
                                        ...
                                        child: Container(
                                          margin: const EdgeInsets.only(left: 16,right: 16,top: 108),
                                    ...
                                    Align(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          buildBrandList(context, homeData),
                                        ],
                                      ),
                                    ),
                            ...
                            SliverToBoxAdapter(
                              child: buildCategoryList(context,homeData),
                            ),
                            SliverList(
                              delegate: SliverChildListDelegate([
  ...
  int i = 0;
  buildCategoryList(context, HomePresenter homeData) {
    if (homeData.isCategoryInitial &&
      ...
      for (int i = 0, j = 0; i < 10; i += 2, j++) {
        ...
        if (j % 2 == 0) {
          o = 130;
          t = MediaQuery.of(context).size.width - (o + 56);
        } else {
          t = 130;
          o = MediaQuery.of(context).size.width - (t + 56);
        }
        ...
        if (i < 10) {
          children.add(Container(
            ...
            // child: buildCategoryItemCard(snapshot.data, i),
          ));
        ...
        if (i + 1 < 10) {
          children.add(Container(
            ...
            child: ShimmerHelper().buildBasicShimmer(),
            decoration: BoxDecorations.buildBoxDecoration_1(),
            // child: buildCategoryItemCard(snapshot.data, i + 1),
          ));
        }
        widgets.add(Row(
          mainAxisAlignment: children.length.isOdd
      ...
      List data = homeData.featuredCategoryList;
      List<Widget> widgets = [];
      for (int i = 0, j = 0; i < data.length; i += 2, j++) {
        ...
        if (i < data.length) {
          children.add(Container(
            ...
            height: 160,
            width: o,
            child: buildCategoryItemCard(homeData.featuredCategoryList, i),
          ));
        ...
        if (i + 1 < data.length) {
          children.add(Container(
            ...
            height: 160,
            width: t,
            child: buildCategoryItemCard(homeData.featuredCategoryList, i + 1),
          ));
        }
        widgets.add(Row(
            ...
            MaterialPageRoute(
              builder: (context) {
                return CategoryProducts(
                  slug: categoryResponse[index].slug ,
                );
              },
            ),
          );
              ...
              Container(
                ...
                child: ClipRRect(
                  ...
                  child: FadeInImage.assetNetwork(
                    ...
                    image: categoryResponse[index].banner,
                    fit: BoxFit.contain,
                    height: itemWidth,
  ...
  Widget buildBrandList(context, HomePresenter homeData) {
    if (homeData.brandList.length > 0){
      return SizedBox(
        height: 60,
        child: ListView.separated(
                ...
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return BrandProducts(
                      slug: homeData.brandList[index].slug!,
                    );
                  }));
            ...
            itemCount: homeData.brandList.length),
      );
    }else if (homeData.isBrandInitial && homeData.brandList.length == 0){
      return  SizedBox( height: 60,child: ListView.builder(
        itemCount: 10,
        scrollDirection: Axis.horizontal,
        padding: EdgeInsets.only(left: 18, right: 18, bottom: 10),
        physics: const BouncingScrollPhysics(
