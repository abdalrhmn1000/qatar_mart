      ...
      child: Scaffold(
          ...
          bottomNavigationBar: Padding(
            ...
            child: Row(
              ...
              children: [
                if (_productDetails?.shop_address != null)
                  InkWell(
                    onTap: () {
                      _launchUrl(_productDetails!.shop_address!);
                ...
                if (_productDetails?.shop_phone != null)
                  InkWell(
                    onTap: () async {
                      final url =
                          'https://wa.me/${_productDetails!.shop_phone!}?text='; //TODO test
                ...
                if (_productDetails?.shop_phone != null)
                  InkWell(
                    onTap: () async {
                      await _makePhoneCall(_productDetails!.shop_phone!);
                      // onPressAddToCart(context, _addedToCartSnackbar);
                    },
                    child: Container(
                      width: MediaQuery.sizeOf(context).width * 0.25,
