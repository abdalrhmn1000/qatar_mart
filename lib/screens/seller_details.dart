...
class _SellerDetailsState extends State<SellerDetails> {
  ...
  Widget buildHomeCarouselSlider(context,) {
    if (isBannerThreeInitial ) {
    ...
    } else if (bannerThreeImageList.length > 0) {
      return CarouselSlider(
        ...
        items: bannerThreeImageList.map((i) {
          return Builder(
                  ...
                  children: <Widget>[
                    ...
                    Align(
                      ...
                      child: Row(
                        ...
                        children: bannerThreeImageList.map((url) {
                          int index =
                              bannerThreeImageList.indexOf(url);
                          return Container(
                            width: 7.0,
                            height: 7.0,
